...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun  6 16:28:00 2020
...
class EasyApplyBot:
    ...
    def __init__(self,username,password, language, position, location, resumeloctn, appliedJobIDs, filename):
        ...
        self.browser = webdriver.Chrome(executable_path = "/Users/SerDuran/Desktop/CVsender/chromedriver")
        #self.browser = webdriver.Chrome(chrome_options=self.options, executable_path = '/Users/SerDuran/Desktop/CVsender/chromedriver.exe')
    ...
    def start_linkedin(self,username,password):
        print("\nLogging in.....\n \nPlease wait :) \n ")
        self.browser.get("https://www.linkedin.com/uas/login?session_redirect=https%3A%2F%2Fwww%2Elinkedin%2Ecom%2Fprofile%2Fpreview%3Flocale%3Des_ES%26trk%3Dprof-0-sb-preview-primary-button&fromSignIn=true&trk=cold_join_sign_in")
        try:
